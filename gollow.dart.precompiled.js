...
for(x=0;x<y;++x){w=a[x]
v=b[x]
if(!(H.VZ(w,v)||H.VZ(v,w)))return!1}return!0},
...
v=b[w]
u=a[w]
if(!(H.VZ(v,u)||H.VZ(u,v)))return!1}return!0},
...
n=w[m]
if(!(H.VZ(o,n)||H.VZ(n,o)))return!1}for(m=0;m<q;++l,++m){o=v[l]
n=u[m]
if(!(H.VZ(o,n)||H.VZ(n,o)))return!1}}return H.Vt(a.named,b.named)},
...
VX:{
"^":"Tp:11;c",
$1:function(a){return this.c(a)}}}],["","culture.dart",,F,{
"^":"",
pn:{
"^":"a;m2,R,cN",
ZY:function(a){var z,y,x,w,v,u
for(z=this.cN,y=this.R,x=this.m2,w=0;w<a;++w){v=z.j1(y)
u=z.j1(y)
x.t(0,""+v+"-"+u).ZQ=1}},
Li:function(){var z=this.m2
z.aN(0,new F.R4())
z.aN(0,new F.Yq())},
eE:function(){var z,y,x,w
for(z=this.R,y=this.m2,x=0;x<z;++x)for(w=0;w<z;++w)y.u(0,""+x+"-"+w,new F.CQ(x,w,y,0,-1,0,0))},
static:{Da:function(){var z=P.Fl(null,null)
z=new F.pn(z,80,C.pr)
z.eE()
return z}}},
R4:{
"^":"Tp:12;",
$2:function(a,b){return b.Li()}},
Yq:{
"^":"Tp:12;",
$2:function(a,b){return b.bR()}},
CQ:{
"^":"a;x,y,Lp,ZQ,Wl,Lh,iY",
Li:function(){var z=this.VV();++this.iY
if(this.ZQ===1&&z===2||z===3){this.Wl=1;++this.Lh}else{this.Wl=0
this.Lh=0}},
bR:function(){this.ZQ=this.Wl},
VV:function(){var z,y,x,w,v,u,t
for(z=this.x,y=this.y,x=0,w=-1;w<=1;++w)for(v=z+w,u=w===0,t=-1;t<=1;++t){if(u&&t===0)continue
if(this.ZC(v,y+t))++x}return x},
ZC:function(a,b){var z=this.Lp.t(0,""+a+"-"+b)
if(z==null)return!1
if(z.ZQ===1)return!0
else return!1}}}],["dart._internal","dart:_internal",,H,{
"^":"",
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"QC","$2","$1","gaq",2,2,3,4],
OH:function(a){var z
...
xp:{
"^":"Tp:9;d",
$0:function(){this.d.QC(new P.lj("No elements"))}},
MO:{
"^":"a;"},
Kd:{
"^":"a;",
...
return}throw"Unable to print message: "+String(a)}}],["","gollow.dart",,V,{
"^":"",
QL:[function(){var z,y
$.dP=J.PB(document.querySelector("#surface"),"2d")
z=699+$.DL().j1(99)
$.O8().ZY(z)
$.mj().ZY(C.jn.Z(z,1.1))
$.nf().ZY(C.jn.Z(z,1.2))
...
J.AB($.dP,255,255,255)
z=$.x0()
y=C.CD.Z(z.giU()*1000000,z.dI)
z=$.eI
if(typeof z!=="number")return H.s(z)
J.mi($.dP,"FPS: "+C.CD.Sy(1000000/(y-z),1),10,10)
$.eI=y
P.rT(C.RT,V.ix())},"$0","ix",0,0,1],
E2:function(a,b,c,d){var z,y,x,w,v,u,t,s,r
z=a.R
for(y=0;y<z;++y)for(x=y*10+5,w=0;w<z;++w){v=a.m2.t(0,""+y+"-"+w)
if(v.ZQ!==0){u=C.jn.Y(y*w*v.Lh*v.iY,255)
t=b?u:0
s=c?u:0
r=d?u:0
J.oj($.dP,t,s,r,128)
J.Dg($.dP)
J.Rb($.dP,x,w*10+5,5,0,6.28)
J.Wm($.dP)}}},
vN:{
"^":"Tp:10;",
$1:function(a){return a.Li()}}},1],])
...
I.$lazy($,"rng","cN","DL",function(){return C.pr})
I.$lazy($,"redCells","pf","O8",function(){return F.Da()})
I.$lazy($,"greenCells","vA","mj",function(){return F.Da()})
I.$lazy($,"blueCells","PK","nf",function(){return F.Da()})
I.$lazy($,"yellowCells","ys","jE",function(){return F.Da()})
I.$lazy($,"cultures","Xx","Dv",function(){return[$.O8(),$.mj(),$.nf(),$.jE()]})
I.$lazy($,"stopWatch","t1","x0",function(){return new P.P1(1000000,null,null)})

init.functionAliases={}
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"DZ",ret:P.KN,args:[P.a]},{func:"NT"},{func:"aB",args:[null]},{func:"zx",args:[P.qU]},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(V.HA(),b)},[])}else{(function(b){H.Rq(V.HA(),b)})([])}})
function init(){I.p={}
...
if($desc instanceof Array)$desc=$desc[1]
VX.prototype=$desc
function pn(m2,R,cN){this.m2=m2
this.R=R
this.cN=cN}pn.builtin$cls="pn"
...
if($desc instanceof Array)$desc=$desc[1]
Yq.prototype=$desc
function CQ(x,y,Lp,ZQ,Wl,Lh,iY){this.x=x
this.y=y
this.Lp=Lp
this.ZQ=ZQ
this.Wl=Wl
this.Lh=Lh
this.iY=iY}CQ.builtin$cls="CQ"
...
if($desc instanceof Array)$desc=$desc[1]
vN.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,Ny,Kh,TK,Y5,Gc,QQ,y4,d7,Um,He,mN,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,hY,pS,D0,as,dU,Aa,u5,Yu,iG,jP,FO,xf,Vb,ST,tb,pA,Mi,KD,Ln,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,zD,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,FH,y6,RH,Kn,Z2,QG,BR,vw,aG,J6,Oi,r0,yp,c1,Mq,Nf,Nc,Mx,nA,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,QU,es,jw,lv,U1,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,yu,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UM,ZD,vt,wD,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,wx,P0,xl,Xr,Sl,Jo,Qm,bf,ET,df,zU,K8,xj,dE,ZA,dT,nl,LN,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,JO,mP,O2,aX,NY,cC,RA,IY,JH,jl,bL,w6,yk,WK,hI,Vg,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,pn,R4,Yq,CQ,a7,i1,xy,MH,SU,C6,Ca,b8,Pf,Zf,vs,da,pV,U7,rH,cX,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,lU,xp,MO,Kd,UO,Bc,VT,of,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,dR,uR,QX,fZ,TF,K5,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,b6,tj,zQ,u3,mW,lD,LG,Sw,o0,Ma,Vj,CL,a2,iP,CP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,KN,An,zM,c8,lf,a,mE,P1,qU,Rn,wv,IU,mg,b0,Hs,Ob,GV,Pg,fj,Ip,vN]}